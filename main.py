...
def main():
    ...
    # Step 1.2: Extend IPG files with assembly information
    extend_ipg_files_with_assembly_information()
    
    # Step 1.4: Order IPG rows, so that best assembly comes out on top WORK IN PROGESS!!
    # magic_fucntion_that_does_that()
